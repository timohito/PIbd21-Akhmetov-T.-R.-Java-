...
public class FormCar {
    ...
    private void initialize() {
        ...
        createDozerButton.addActionListener(e -> {
            transport = new Dozer(100, 1000, Color.BLUE, Color.green, 320, 60, true, true, 3, numType);
            transport.setPosition(10, 10, width, height);
            panel.setTransport(transport);
            panel.repaint();
        });
        ...
        squareRollers.setBounds(370, height + 160, 200, 50);
        ...
        TriangleRollers.setBounds(430, height + 220, 200, 50);
